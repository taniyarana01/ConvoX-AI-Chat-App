  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-gradient-to-br from-slate-950 via-slate-900 to-black">
      ...
      <div className="flex flex-col justify-center items-center p-8 sm:p-12">
        <div className="w-full max-w-md space-y-8 bg-slate-900/70 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl">
          {/* LOGO */}
          <div className="text-center mb-8">
          <div className="flex flex-col items-center">

  <div className="w-20 h-20 rounded-3xl bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 flex items-center justify-center shadow-xl shadow-cyan-500/30">
    <MessageSquare className="w-10 h-10 text-white" />
   </div>

  <h1 className="text-5xl font-black mt-5 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">
    ConvoX
      </h1>
    ...
    Join thousands of users collaborating in real-time.
      ...
      <AuthImagePattern
       ...
       subtitle="A modern real-time messaging platform built for seamless communication, collaboration, and productivity."
      />
    </div>
  );
};
